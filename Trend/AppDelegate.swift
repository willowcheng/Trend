...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    // tvBaseURL points to a server on your local machine. To create a local server for testing purposes, use the following command inside your project folder from the Terminal app: python -m SimpleServerHTTP 9001. See NSAppTransportSecurity for information on using a non-secure server.
